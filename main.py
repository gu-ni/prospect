...
def get_parser(**parser_kwargs):
    ...
    parser.add_argument(
        ...
        type=str,
        const=True,
        default="timestep_embedding_0.3contrastive_3foreground_IDENTITY_four_bear",
        nargs="?",
    ...
    parser.add_argument("--actual_resume", type=str, default="./models/sd/v1-5-pruned.ckpt", help="Path to model to actually resume from")
    parser.add_argument("--data_root", type=str, default="./example_images/four_bear_folder", required=False, help="Path to directory with training images")
