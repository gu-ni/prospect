    ...
    def __init__(self, version="openai/clip-vit-large-patch14", device="cuda", max_length=77):
        ...
        def embedding_forward(
                ...
                if embedding_manager is not None:
                    ...
                    inputs_embeds = embedding_manager(input_ids, inputs_embeds, prospect_words = prospect_words) # len(inputs_embeds) = 10. 여기서 inputs_embeds가 '*'에 대한 임베딩에서 prospect_words의 각 문장의 임베딩으로 바뀜.
